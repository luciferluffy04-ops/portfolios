  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-20 text-center">
        ...
        <h1 className="font-display font-bold text-5xl md:text-7xl text-gray-900 leading-[1.05] mb-6">
          Your portfolio,<br />
              ...
              return (
                <div key={step.step} className="flex flex-col gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-bold text-gray-300 tracking-wider">{step.step}</span>
                  </div>
